...
1. Open Shortcuts app → + → Add Action → search "Open URLs".
2. URL: https://your-radio.vercel.app/?genre=relax-edm&autoplay=1
3. Tap the title at the top → rename to e.g. "Start Home Radio".
4. Save.

Now "Hey Siri, Start Home Radio" opens Safari and starts playing. First-time autoplay may need one tap; after that the browser remembers.

Make a couple of variants:
- "Focus Vibes" → ?genre=lofi&mood=focus&autoplay=1
- "Chill EDM" → ?genre=relax-edm&mood=chill&autoplay=1

Optional: shell alias on your Mac

Add to ~/.zshrc:
radio() { open "https://your-radio.vercel.app/?genre=${1:-lofi}&autoplay=1"; }
Then radio relax-edm from any terminal opens the right URL on your Mac.
